...
import { searchListings, generateListings, rehostListingPhotos, rewriteListingTitle } from '../controllers/listings.controller';
...
router.post('/listings/rewrite-title',  verifyAdmin, rewriteListingTitle);
