    ...
    <div className="w-full">
      ...
      <div className="relative">
        <input
          ...
          autoComplete="off"
          className={`w-full h-9 bg-surface-raised border ${borderColor} rounded-lg px-4 pr-10 text-sm text-white focus:outline-none focus:ring-2 focus:ring-primary/50 transition-colors`}
        />
