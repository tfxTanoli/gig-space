...
import { ArrowRight, ChevronLeft, ChevronRight, Car, PenTool, Home, Package, Code, Hammer, Menu, X } from 'lucide-react';
...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-white font-sans flex flex-col">
      ...
      {/* Hero Section */}
      <section className="flex-1 flex flex-col items-center justify-center pt-10 md:pt-24 pb-12 md:pb-16 px-4 text-center relative overflow-hidden">
        <StarryBackground />
        <div className="relative z-10 w-full flex flex-col items-center">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-100 mb-4 md:mb-6">
