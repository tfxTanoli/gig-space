      ...
      `}>
        ...
        <div className="px-4 pb-4 space-y-2">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium text-red-400 hover:text-red-500 hover:bg-red-500/10 transition-colors"
          >
