...
const CARDS: CardDef[] = [
  ...
  { key: 'totalSellers',  label: 'Sellers',             Icon: Store,        color: 'text-emerald-400', bg: 'bg-emerald-500/10',
  ...
  { key: 'totalRevenue',  label: 'Completed Revenue',   Icon: DollarSign,   color: 'text-green-400',   bg: 'bg-green-500/10', isCurrency: true },
];
