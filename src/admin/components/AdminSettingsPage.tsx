...
const NumberInput = ({ id, value, onChange, min, max, step = 1, prefix, suffix }: {
  ...
  <div className="relative flex items-center">
    ...
    <input
      ...
      className={`w-full bg-[#1A2035] border border-slate-700/60 rounded-lg py-2.5 text-sm text-white focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500/50 transition-colors ${prefix ? 'pl-7 pr-3' : suffix ? 'pl-3 pr-9' : 'px-3'}`}
    />
    ...
    <div className="space-y-5">
      ...
      <div className="bg-[#111827] rounded-xl border border-slate-800 overflow-hidden">
        ...
        <div className="px-6 py-5 space-y-4">
          {faqs.map((f) => (
            <div key={f.id} className="bg-[#1A2035] rounded-lg p-4 border border-slate-700/50">
          ...
          <div className="space-y-2 pt-2">
            ...
            <input value={faqQ} onChange={(e) => setFaqQ(e.target.value)} placeholder="Question…" className="w-full bg-[#1A2035] border border-slate-700/50 rounded-lg px-3 py-2 text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/40 transition-colors" />
            <textarea value={faqA} onChange={(e) => setFaqA(e.target.value)} placeholder="Answer…" rows={3} className="w-full bg-[#1A2035] border border-slate-700/50 rounded-lg px-3 py-2 text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/40 transition-colors resize-none" />
      ...
      <div className="bg-[#111827] rounded-xl border border-slate-800 overflow-hidden">
        ...
        <div className="px-6 py-5">
          <textarea value={terms} onChange={(e) => setTerms(e.target.value)} rows={10} placeholder="Enter your Terms & Conditions…" className="w-full bg-[#1A2035] border border-slate-700/50 rounded-lg px-3 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/40 transition-colors resize-none" />
        </div>
        <div className="px-6 py-4 border-t border-slate-800 flex items-center justify-between">
      ...
      <div className="bg-[#111827] rounded-xl border border-slate-800 overflow-hidden">
        ...
        <div className="px-6 py-5">
          <textarea value={privacy} onChange={(e) => setPrivacy(e.target.value)} rows={10} placeholder="Enter your Privacy Policy…" className="w-full bg-[#1A2035] border border-slate-700/50 rounded-lg px-3 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/40 transition-colors resize-none" />
        </div>
        <div className="px-6 py-4 border-t border-slate-800 flex items-center justify-between">
